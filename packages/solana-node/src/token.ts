...
import { BaseNodeToken } from "@irys-network/bundler-client-node/tokens/base";
...
export type SolanaTokenConfig = TokenConfig<any, { finality?: Finality; disablePriorityFees?: boolean }>;
