...
// }
export const Matic: Constructable<[TokenConfigTrimmed], BaseEthereumToken> =
  getBoundEth({
    name: 'matic',
    ticker: 'MATIC',
...
// }
export const BNB: Constructable<[TokenConfigTrimmed], BaseEthereumToken> =
  getBoundEth({
    name: 'bnb',
    ticker: 'BNB',
...
export const Avalanche: Constructable<[TokenConfigTrimmed], BaseEthereumToken> =
  getBoundEth({
    name: 'avalanche',
    ticker: 'AVAX',
...
// }
export const BaseEth: Constructable<[TokenConfigTrimmed], BaseEthereumToken> =
  getBoundEth({
    name: 'base-eth',
    ticker: 'ETH',
...
// }
export const USDCEth: Constructable<[TokenConfigTrimmed], BaseERC20Token> =
  getBoundERC20({
    name: 'usdc-eth',
    ticker: 'USDC',
...
// }
export const Arbitrum: Constructable<[TokenConfigTrimmed], BaseEthereumToken> =
  getBoundEth({
    name: 'arbitrum',
    ticker: 'ETH',
...
// }
export const Chainlink: Constructable<[TokenConfigTrimmed], BaseEthereumToken> =
  getBoundERC20({
    name: 'chainlink',
    ticker: 'LINK',
...
// }
export const USDCPolygon: Constructable<[TokenConfigTrimmed], BaseERC20Token> =
  getBoundERC20({
    name: 'usdc-polygon',
    ticker: 'USDC',
    providerUrl: 'https://polygon-rpc.com',
...
// }
export const Bera: Constructable<[TokenConfigTrimmed], BaseEthereumToken> =
  getBoundEth({
    name: 'bera',
    ticker: 'BERA',
...
// }
export const ScrollEth: Constructable<[TokenConfigTrimmed], BaseEthereumToken> =
  getBoundEth({
    name: 'scroll-eth',
    ticker: 'ETH',
...
// }
export const LineaEth: Constructable<[TokenConfigTrimmed], BaseEthereumToken> =
  getBoundEth({
    name: 'linea-eth',
    ticker: 'ETH',
...
// }
export const Iotex: Constructable<[TokenConfigTrimmed], BaseEthereumToken> =
  getBoundEth({
    name: 'iotex',
    ticker: 'IOTX',
...
// }
export const Ethereum: Constructable<[TokenConfigTrimmed], BaseEthereumToken> =
  EthereumToken;
