...
import {
  type ConstructableWebToken,
  type TokenConfigTrimmed,
} from '@irys/web-upload';
...
export const WebEclipseEth: ConstructableWebToken = getBoundSolana({
  name: 'eclipse-eth',
  ticker: 'ETH',
...
export const WebUSDCSolana: ConstructableWebToken = getBoundSPL({
  name: 'usdc-solana',
  ticker: 'USDC',
