...
export const WebMatic: Constructable<[TokenConfigTrimmed], BaseWebToken> =
  getBoundEth({
    name: 'matic',
    ticker: 'MATIC',
...
// }
export const WebBNB: Constructable<[TokenConfigTrimmed], BaseWebToken> =
  getBoundEth({
    name: 'bnb',
    ticker: 'BNB',
...
// }
export const WebAvalanche: Constructable<[TokenConfigTrimmed], BaseWebToken> =
  getBoundEth({
    name: 'avalanche',
    ticker: 'AVAX',
...
// }
export const WebBaseEth: Constructable<[TokenConfigTrimmed], BaseWebToken> =
  getBoundEth({
    name: 'base-eth',
    ticker: 'ETH',
...
// }
export const WebUSDCEth: Constructable<[TokenConfigTrimmed], BaseERC20Token> =
  getBoundERC20({
    name: 'usdc-eth',
    ticker: 'USDC',
...
// }
export const WebArbitrum: Constructable<[TokenConfigTrimmed], BaseWebToken> =
  getBoundEth({
    name: 'arbitrum',
    ticker: 'ETH',
...
// }
export const WebChainlink: Constructable<[TokenConfigTrimmed], BaseERC20Token> =
  getBoundERC20({
    name: 'chainlink',
    ticker: 'LINK',
...
// }
export const WebUSDCPolygon: Constructable<
  [TokenConfigTrimmed],
  BaseERC20Token
> = getBoundERC20({
  name: 'usdc-polygon',
...
// }
export const WebBera: Constructable<[TokenConfigTrimmed], BaseWebToken> =
  getBoundEth({
    name: 'bera',
    ticker: 'BERA',
...
// }
export const WebScrollEth: Constructable<[TokenConfigTrimmed], BaseWebToken> =
  getBoundEth({
    name: 'scroll-eth',
    ticker: 'ETH',
...
// }
export const WebLineaEth: Constructable<[TokenConfigTrimmed], BaseWebToken> =
  getBoundEth({
    name: 'linea-eth',
    ticker: 'ETH',
...
// }
export const WebIotex: Constructable<[TokenConfigTrimmed], BaseWebToken> =
  getBoundEth({
    name: 'iotex',
    ticker: 'IOTX',
...
export const WebEthereum: Constructable<[TokenConfigTrimmed], BaseWebToken> =
  EthereumToken;
